...
- Creates a ZooKeeper ensemble from the [Bitnami](https://github.com/bitnami/charts/tree/master/bitnami/zookeeper) ZooKeeper Helm chart
...
[Stardog documentation](https://docs.stardog.com/operating-stardog/server-administration/backup-and-restore)
includes an overview of the various options for backing up Stardog. Only S3 backups will copy
...
and `stardog-admin ps list`.
- Backup Stardog home and copy the backup out of the k8s environment. The
[Stardog documentation](https://docs.stardog.com/operating-stardog/server-administration/backup-and-restore) includes
